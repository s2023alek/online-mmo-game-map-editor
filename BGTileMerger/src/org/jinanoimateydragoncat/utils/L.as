package org.jinanoimateydragoncat.utils {
	...
	public class L {
		...
		public static function traceObject(o:Object):String {
			var r:String='';
			if (o is Array) {
				r = '[';
				for (var ii:uint in o) {
		 ...
		 */
		public static function strrep (a:String, what:String, by:String):String {
			if (a.indexOf(what) == -1) {return a;}
			return a.split(what).join(by);
		}
		...
		public static function replaceArgumentsInString (targetString:String, replaceBy:Array, argumentPrefix:String = "%"):String {
			...
			for (var i:uint = 0;i < l;i++ ) {
				if (targetString.indexOf(argumentPrefix+ i)) {
					targetString = strrep(targetString, argumentPrefix+ i, replaceBy[i]);
				}
			}
			return targetString;
		}
